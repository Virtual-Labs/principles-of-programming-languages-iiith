...
2. Include all the scheme code in this file. 
3. Zip all the files required for the experiment and upload them. The name of the zip file should be environment.zip.
#+END_EXAMPLE
