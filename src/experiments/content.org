...
- While uploading the experiments, the name of the zip file should follow the convention specified in the experiments. 
- The terminal has been provided to enable scheme on your browser. It gives the command line racket. 
- You can view your uploaded files in the terminal as well. 
- To login using the terminal, use the same username and password with which you have registered. And, use following credentials:

Host/IP or SSH URL [localhost]: 10.2.48.12
Port [22] : 22
